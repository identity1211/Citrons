...
<head>
  ...
  <link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'><rect width='32' height='32' rx='6' fill='%23145230'/><circle cx='16' cy='16' r='11' fill='none' stroke='%23d4af37' stroke-width='1.5'/><text x='16' y='21' text-anchor='middle' font-size='14' fill='%23f1c40f'>🍋</text></svg>" />
  <style>
