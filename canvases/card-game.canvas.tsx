...
function TableSkinPicker({
  ...
  return (
    <div style={{ width: "100%", maxWidth: fill ? "none" : 300, flexShrink: 0 }}>
      <div
        style={{
          fontSize: 11,
          fontWeight: 800,
