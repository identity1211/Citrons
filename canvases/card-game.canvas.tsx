...
function cardBackFill(id: CardBackId): CSSProperties {
  if (id === "shades") {
    return {
      backgroundColor: "#145230",
      backgroundImage: `url(${SHADES_BACK_SRC})`,
  ...
  if (id === "sweaty") {
    return {
      ...
      backgroundImage: `url(${SWEATY_BACK_SRC})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
    };
  ...
  if (id === "camera") {
    return {
      ...
      backgroundImage: `url(${CAMERA_BACK_SRC})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
    };
  ...
  if (id === "dealer") {
    return {
      ...
      backgroundImage: `url(${DEALER_BACK_SRC})`,
      backgroundSize: "cover",
      backgroundPosition: "center",
      backgroundRepeat: "no-repeat",
    };
