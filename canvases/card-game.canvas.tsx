...
const STYLE_ID = "card-game-keyframes-v19";
...
function RoomChat({
  ...
  const kbOpen = open && (inset.keyboard || kbLift > 40);
  ...
  return (
    <>
      ...
      {open ? (
        <form
          className={`chat-ime-bar ${kbOpen ? "is-ime" : "is-docked"}`}
          onSubmit={(e) => {
            e.preventDefault();
            submit();
          }}
          ...
          >
            ...
            >
              <div
                ...
                style={{ color: "#f5f0e6", fontWeight: 800, fontSize: 18, marginBottom: 14 }}
              >
                New lobby
              </div>
              <input
                ...
                autoComplete="off"
                style={{ ...LOBBY_INPUT, maxWidth: "100%", marginBottom: 12 }}
              />
