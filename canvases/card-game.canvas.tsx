...
function ensureKeyframes() {
  ...
  style.textContent = `
    ...
    .look-rail > button { scroll-snap-align: start; flex: 0 0 auto; }
    .chat-ime-bar {
      position: fixed;
      z-index: 140;
      display: flex;
...
function LobbyStylePickers({
  ...
  return (
    <div style={{ width: "100%", flexShrink: 0, position: "relative", zIndex: 12 }}>
      <div
        style={{
          fontSize: 11,
          fontWeight: 800,
      ...
      <div style={{ marginBottom: 10 }}>
        ...
        <div className="look-rail" role="listbox" aria-label="Table skin" aria-disabled={disabled || undefined}>
          {TABLE_SKINS.map((s) => {
            const on = s.id === table;
            return (
              <button
              ...
              >
                ...
                />
                <span style={on ? selectedName : nameUnder}>{s.name}</span>
              </button>
            );
          })}
        </div>
      ...
      <div>
        <div style={rowLabel}>Card back</div>
        <div className="look-rail" role="listbox" aria-label="Card back" aria-disabled={disabled || undefined}>
          {CARD_BACKS.map((s) => {
            const on = s.id === back;
            return (
              <button
      ...
      {disabled ? (
        <div style={{ fontSize: 11, color: "rgba(255,255,255,0.5)", marginTop: 8, textAlign: "left" }}>
          Host chooses the table and card back
        </div>
      ) : null}
    </div>
  );
          ...
          <>
            ...
            <div
              style={{
                ...
                zIndex: 8,
                pointerEvents: "auto",
                display: inset.keyboard ? "none" : "block",
              }}
            >
              {view.host ? (
                <button
                ...
                >
                  {view.canStart ? "Start game" : "Waiting…"}
                </button>
              ) : (
                <div
                  style={{
              ...
              >
                {view.lobby.map((p) => (
                  ...
                  >
                    ...
                    <span style={{ opacity: 0.65, flexShrink: 0, fontSize: 12 }}>
