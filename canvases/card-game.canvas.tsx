  ...
  if (screen === "waiting" && view) {
    ...
    return (
      <FeltShell
        ...
        style={{
          padding: "max(44px, calc(env(safe-area-inset-top) + 28px)) max(12px, env(safe-area-inset-right)) max(56px, calc(env(safe-area-inset-bottom) + 48px)) max(12px, env(safe-area-inset-left))",
          alignItems: "stretch",
